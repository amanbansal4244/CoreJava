...
public class ModifiedFieldValueAfterSerializationWithOverridingReadObjectandReadResolve implements Serializable {
   private static final long serialVersionUID = 1L;
   private static ModifiedFieldValueAfterSerializationWithOverridingReadObjectandReadResolve INSTANCE = new ModifiedFieldValueAfterSerializationWithOverridingReadObjectandReadResolve();
   private int x;
   ...
   public static ModifiedFieldValueAfterSerializationWithOverridingReadObjectandReadResolve getInstance() {
          return INSTANCE;
   }
   //constructor
   private ModifiedFieldValueAfterSerializationWithOverridingReadObjectandReadResolve() {}
   /**
   ...
   public static void main(String[] args) throws Throwable {
	   ModifiedFieldValueAfterSerializationWithOverridingReadObjectandReadResolve object1 = ModifiedFieldValueAfterSerializationWithOverridingReadObjectandReadResolve.getInstance();
          object1.x = 22;
...
value of x during DeSerialization was 22 (i.e. we were successfully able to get the state of object in
