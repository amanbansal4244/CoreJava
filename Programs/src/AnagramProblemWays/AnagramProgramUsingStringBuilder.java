...
/*This method is also same as above method. But in this method, we use StringBuilder deletechartAt() method to delete the character from 
second string if that character is present in it.*/
public class AnagramProgramUsingStringBuilder {
