...
//Best solution among all anagrams in term of complexity
import java.util.HashMap;

/*In this method, we construct one HashMap object with character as Key and character occurrences as Value.
We increment character count by 1 on total count in first string and decrement it by 1 in second string on 
total count from 2nd string.
At last, we check character count for each character in the map. If any count is not equal to 0, 
then given strings are not anagrams.*/
