...
public class MaXAndMinElementUsingDivideConquerRule {
	
	    static MaXAndMinElementUsingDivideConquerRule m=new MaXAndMinElementUsingDivideConquerRule();
	    static int max,min;
	    
	    public static void main(String ar[])
	    {
	        int a[]={10,12,9,7,15,11,1};
	        MaXAndMinElementUsingDivideConquerRule.max=MaXAndMinElementUsingDivideConquerRule.min=a[0];
