...
*/public class QuestionBasedOnHAshSet2 {

	QuestionBasedOnHAshSet2(){
	 ...
	 public static void main(String[] args) {
		 QuestionBasedOnHAshSet2 obj = new QuestionBasedOnHAshSet2();
		 
		 HashSet setObj = new HashSet<QuestionBasedOnHAshSet2>();
		 for(int i =0; i< 5; i++){
			 setObj.add(1);
		 }
		 
		 System.out.println("Size of hashset is :" + setObj.size());
		 System.out.println("Contains: " + setObj.contains(new QuestionBasedOnHAshSet2()));
	}
}
