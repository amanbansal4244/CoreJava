...
/****
 * By creating this bean, If our application needs to know which task gave which result.
 * We can easily get this information by invoking getter methods of this bean 'TaskResult'
 * @author bansal
 *
 * @param <S>
 * @param <R>
