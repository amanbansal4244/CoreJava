package _8AlarmClock_UsingScheduleThreadPoolExecutor;
...
/**
 Run a simple task once every two second, starting 3 seconds from now.
...
public final class AlarmClock {
  ...
  public static void main(String... aArgs) throws InterruptedException {
    log("Main started.");
    AlarmClock alarmClock = new AlarmClock(3, 2, 20);
    ...
    AlarmClock alarm = new AlarmClock(startTime, 2, 20);
